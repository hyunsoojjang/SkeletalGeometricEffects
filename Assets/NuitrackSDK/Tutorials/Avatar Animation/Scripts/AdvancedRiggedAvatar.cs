...
namespace NuitrackSDK.Tutorials.AvatarAnimation
{
    ...
    public class AdvancedRiggedAvatar : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //{
            //    for (int i = 0; i < NuitrackManager.sensorsData.Count; i++)
            //    {
            //        if (NuitrackManager.sensorsData[i] != null && NuitrackManager.sensorsData[i].SkeletonTracker != null)
            //            ProcessSkeleton(NuitrackManager.sensorsDatai[i].n);
            //    }
            //}
