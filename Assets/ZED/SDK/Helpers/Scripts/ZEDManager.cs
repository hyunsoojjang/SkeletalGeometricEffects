...
#pragma warning restore 414
    ...
    void Awake()
    {
        ...
        Debug.Log($"{initialPosition}= initialPosition awake");
    ...
    private void ZEDReady()
    {
        ...
        else
        {
            ...
            Debug.Log($"{OriginPosition}= OriginPosition zedready");

            OriginRotation = initialRotation;
        }

        //Set the original transform for the Rig
        Debug.Log($"{OriginPosition}= OriginPosition zedready end");
